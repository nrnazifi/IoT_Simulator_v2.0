...
import stylesCss from 'themes/iotsimulator/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_iotsimulator_componentCss']) {
    
    document['_vaadintheme_iotsimulator_componentCss'] = true;
  }

package edu.campuswien.smartcity.views;
 ...
 */
@PWA(name = "IoT_Simulator", shortName = "IoT_Simulator", enableInstallPrompt = false)
@Theme(themeFolder = "iotsimulator")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("IoT_Simulator");
